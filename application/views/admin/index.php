...
<div class="container">
	...
	<div class="row margin">
		<div class="col-md-2"><h3>Title</h3></div>3
	...
	<div class="row margin">
		...
		<div class="col-md-1"><a type="button" href="<?php echo base_url().'admin/editNews/id/'.$news_item['id'] ?>" class="btn btn-warning" aria-label="Left Align"><span class="glyphicon glyphicon-pencil"   aria-hidden="true"></span></a></div>
